...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-04-21 11:58:11 CST → 2026-04-23 11:59:20 CST |
| 📄 论文总数 | **13** 篇 |
...
> 💡 今日共收录 13 篇新论文，主要分布在 Speech LLM 1, ASR 2, Enhancement 1, Paralinguistics 1, Audio 8。
...
🔗 **来源**: [https://arxiv.org/abs/2604.20842v1](https://arxiv.org/abs/2604.20842v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音大模型」方向，核心任务由题目《SpeechParaling-Bench: A Comprehensive Benchmark for Paralinguistic-Aware Speech Generation》所界定。 从摘要看，作者主要围绕 audio-language model 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：To address these challenges, we introduce SpeechParaling-Bench, a comprehensive benchmark for paralinguistic-aware speech generation. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
🔗 **来源**: [https://arxiv.org/abs/2604.19949v1](https://arxiv.org/abs/2604.19949v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Indic-CodecFake meets SATYAM: Towards Detecting Neural Audio Codec Synthesized Speech Deepfakes in Indic Languages》所界定。 从摘要看，作者主要围绕 whisper 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our experiments demonstrate that state-of-the-art (SOTA) CF detectors trained on English-centric datasets fail to generalize to ICF, underscoring the challenges posed by phonetic diversity and prosodic variability in Indic speech. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：whisper。 |

---
### 2. ATIR: Towards Audio-Text Interleaved Contextual Retrieval

👤 **作者**: Tong Zhao, Chenghao Zhang, Yutao Zhu, Zhicheng Dou
🔗 **来源**: [https://arxiv.org/abs/2604.20267v1](https://arxiv.org/abs/2604.20267v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《ATIR: Towards Audio-Text Interleaved Contextual Retrieval》所界定。 从摘要看，作者主要围绕 automatic speech recognition、speech-to-text 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experimental results demonstrate that our ATIR model achieves substantial improvements over strong baselines. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：automatic speech recognition, speech-to-text。 |
...
🔗 **来源**: [https://arxiv.org/abs/2604.20270v1](https://arxiv.org/abs/2604.20270v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音增强」方向，核心任务由题目《Embedding-Based Intrusive Evaluation Metrics for Musical Source Separation Using MERT Representations》所界定。 从摘要看，作者主要围绕 source separation 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experiments on two independent datasets show that these metrics correlate more strongly with perceptual audio quality ratings than traditional BSS-Eval metrics across all analyzed stem and model types. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
### 1. Enhancing Speaker Verification with Whispered Speech via Post-Processing

👤 **作者**: Magdalena Gołębiowska, Piotr Syga
🔗 **来源**: [https://arxiv.org/abs/2604.20229v1](https://arxiv.org/abs/2604.20229v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「副语言学」方向，核心任务由题目《Enhancing Speaker Verification with Whispered Speech via Post-Processing》所界定。 从摘要看，作者主要围绕 whisper、speaker verification 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We gain relative improvement of 22.26\% compared to the baseline (baseline 6.77\% vs ours 5.27\%) in normal vs whispered speech trials, achieving AUC of 98.16\%. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：whisper, speaker verification。 |
...
🔗 **来源**: [https://arxiv.org/abs/2604.19477v1](https://arxiv.org/abs/2604.19477v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Deep Supervised Contrastive Learning of Pitch Contours for Robust Pitch Accent Classification in Seoul Korean》所界定。 从摘要看，作者主要围绕 deep、supervised、contrastive 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experimental results show that our Dual-Glob significantly outperforms strong baseline models with state-of-the-art accuracy (77.75%) and F1-score (51.54%). 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：deep, supervised, contrastive。 |

---
### 2. BEAT: Tokenizing and Generating Symbolic Music by Uniform Temporal Steps

👤 **作者**: Lekai Qian, Haoyu Gu, Jingwei Zhao, Ziyu Wang
🔗 **来源**: [https://arxiv.org/abs/2604.19532v1](https://arxiv.org/abs/2604.19532v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《BEAT: Tokenizing and Generating Symbolic Music by Uniform Temporal Steps》所界定。 从摘要看，作者主要围绕 beat、tokenizing、generating 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Results show improved musical quality and structural coherence, while additional analyses confirm higher efficiency and more effective capture of long-range patterns with the proposed tokenization. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：beat, tokenizing, generating。 |

---
### 3. Towards Streaming Target Speaker Extraction via Chunk-wise Interleaved Splicing of Autoregressive Language Model
...
🔗 **来源**: [https://arxiv.org/abs/2604.19635v1](https://arxiv.org/abs/2604.19635v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Towards Streaming Target Speaker Extraction via Chunk-wise Interleaved Splicing of Autoregressive Language Model》所界定。 从摘要看，作者主要围绕 towards、streaming、target 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experiments on Libri2Mix show that while AR generative baseline exhibits performance degradation at low latencies, our approach maintains 100% stability and superior intelligibility. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：towards, streaming, target。 |

---
### 4. Environmental Sound Deepfake Detection Using Deep-Learning Framework

👤 **作者**: Lam Pham, Khoi Vu, Dat Tran, Phat Lam, Vu Nguyen, David Fischinger, Alexander Schindler, Martin Boyer, Son Le
🔗 **来源**: [https://arxiv.org/abs/2604.19652v1](https://arxiv.org/abs/2604.19652v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Environmental Sound Deepfake Detection Using Deep-Learning Framework》所界定。 从摘要看，作者主要围绕 environmental、sound、deepfake 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Eventually, our best model, which was finetuned from the pre-trained WavLM model with the proposed three-stage training strategy, achieve the Accuracy of 0.98, F1 Score of 0.95, AuC of 0.99 on EnvSDD Test subset and the Accuracy of 0.88, F1 Score of 0.77, and AuC of 0.92 on ESDD-Challenge-TestSet dataset. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：environmental, sound, deepfake。 |

---
### 5. Tonnetz Theory, Classical Harmony, and the Combinatorial Geometry of Abstract Musical Resources

👤 **作者**: Jeffrey R. Boland, Lane P. Hughston
🔗 **来源**: [https://arxiv.org/abs/2604.19960v1](https://arxiv.org/abs/2604.19960v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Tonnetz Theory, Classical Harmony, and the Combinatorial Geometry of Abstract Musical Resources》所界定。 从摘要看，作者主要围绕 tonnetz、theory、classical 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：It was shown that the Eulerian tonnetz can be represented by a $\{12_3\}$ of Daublebsky von Sterneck type D222. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：tonnetz, theory, classical。 |

---
### 6. Before the Mic: Physical-Layer Voiceprint Anonymization with Acoustic Metamaterials

👤 **作者**: Zhiyuan Ning, Zhanyong Tang, Xiaojiang Chen, Zheng Wang
🔗 **来源**: [https://arxiv.org/abs/2604.20116v1](https://arxiv.org/abs/2604.20116v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Before the Mic: Physical-Layer Voiceprint Anonymization with Acoustic Metamaterials》所界定。 从摘要看，作者主要围绕 before、physical-layer、voiceprint 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experiments conducted across eight microphones in diverse environments demonstrate that EchoMask increases the Miss-match Rate, i.e., the fraction of failed voiceprint matching attempts, to over 90%, while maintaining high speech intelligibility. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：before, physical-layer, voiceprint。 |

---
### 7. From Image to Music Language: A Two-Stage Structure Decoding Approach for Complex Polyphonic OMR

👤 **作者**: Nan Xu, Shiheng Li, Shengchao Hou
🔗 **来源**: [https://arxiv.org/abs/2604.20522v1](https://arxiv.org/abs/2604.20522v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《From Image to Music Language: A Two-Stage Structure Decoding Approach for Complex Polyphonic OMR》所界定。 从摘要看，作者主要围绕 from、image、music 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Given symbol and event candidates from the visual pipeline, we decode them into an editable, verifiable, and exportable score structure. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：from, image, music。 |

---
### 8. ONOTE: Benchmarking Omnimodal Notation Processing for Expert-level Music Intelligence

👤 **作者**: Menghe Ma, Siqing Wei, Yuecheng Xing, Yaheng Wang, Fanhong Meng, Peijun Han, Luu Anh Tuan, Haoran Luo
🔗 **来源**: [https://arxiv.org/abs/2604.20719v1](https://arxiv.org/abs/2604.20719v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《ONOTE: Benchmarking Omnimodal Notation Processing for Expert-level Music Intelligence》所界定。 从摘要看，作者主要围绕 onote、benchmarking、omnimodal 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Current research remains fragmented, focusing on isolated transcription tasks that fail to bridge the gap between superficial pattern recognition and the underlying musical logic. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：onote, benchmarking, omnimodal。 |
