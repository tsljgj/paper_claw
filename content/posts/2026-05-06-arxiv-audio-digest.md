...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-05-04 12:34:18 CST → 2026-05-06 12:27:39 CST |
| 📄 论文总数 | **20** 篇 |
...
> 💡 今日共收录 20 篇新论文，主要分布在 ASR 5, Audio 15。
...
### 1. Dimensionality-Aware Anomaly Detection in Learned Representations of Self-Supervised Speech Models

👤 **作者**: Sandra Arcos-Holzinger, Sarah M. Erfani, James Bailey, Sanjeev Khudanpur
🔗 **来源**: [https://arxiv.org/abs/2605.02715v1](https://arxiv.org/abs/2605.02715v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Dimensionality-Aware Anomaly Detection in Learned Representations of Self-Supervised Speech Models》所界定。 从摘要看，作者主要围绕 automatic speech recognition、wav2vec 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Self-supervised speech models (S3Ms) achieve strong downstream performance, yet their learned representations remain poorly understood under natural and adversarial perturbations. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：automatic speech recognition, wav2vec。 |
...
🔗 **来源**: [https://arxiv.org/abs/2605.02782v1](https://arxiv.org/abs/2605.02782v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《When Audio-Language Models Fail to Leverage Multimodal Context for Dysarthric Speech Recognition》所界定。 从摘要看，作者主要围绕 audio-language model、automatic speech recognition 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Recent audio-language models raise the possibility of improving performance by conditioning on additional clinical context at inference time, but it is unclear whether these models can make use of such information. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：audio-language model, automatic speech recognition。 |

---
### 3. The TTS-STT Flywheel: Synthetic Entity-Dense Audio Closes the Indic ASR Gap Where Commercial and Open-Source Systems Fail

👤 **作者**: Venkata Pushpak Teja Menta
🔗 **来源**: [https://arxiv.org/abs/2605.03073v1](https://arxiv.org/abs/2605.03073v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《The TTS-STT Flywheel: Synthetic Entity-Dense Audio Closes the Indic ASR Gap Where Commercial and Open-Source Systems Fail》所界定。 从摘要看，作者主要围绕 whisper 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：On a synthesised entity-dense Telugu test set (held-out by synthesis system), vasista22/whisper-telugu-large-v2 (open SOTA) achieves Entity-Hit-Rate (EHR) 0.027 and Deepgram Nova-3 (commercial) 0.16. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：whisper。 |

---
### 4. Contrastive Regularization for Accent-Robust ASR

👤 **作者**: Van-Phat Thai, Aradhya Dhruv, Duc-Thinh Pham, Sameer Alam
🔗 **来源**: [https://arxiv.org/abs/2605.03297v1](https://arxiv.org/abs/2605.03297v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Contrastive Regularization for Accent-Robust ASR》所界定。 从摘要看，作者主要围绕 asr system 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：ASR systems based on self-supervised acoustic pretraining and CTC fine-tuning achieve strong performance on native speech but remain sensitive to accent variability. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：asr system。 |

---
### 5. Assessing the Impact of Noise and Speech Enhancement on the Intelligibility of Speech Codecs

👤 **作者**: Lyonel Behringer, Anna Leschanowsky, Anjana Rajasekhar, Emily Kratsch, Guillaume Fuchs
🔗 **来源**: [https://arxiv.org/abs/2605.03776v1](https://arxiv.org/abs/2605.03776v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Assessing the Impact of Noise and Speech Enhancement on the Intelligibility of Speech Codecs》所界定。 从摘要看，作者主要围绕 automatic speech recognition、speech enhancement 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The results show that classical codecs are more noise robust than neural codecs. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：automatic speech recognition, speech enhancement。 |
...
### 1. Neck-Learn: Attention-Based Multiple Instance Learning and Ensemble Framework for Ecological Momentary Assessment

👤 **作者**: Ahsan Jamal Cheema
🔗 **来源**: [https://arxiv.org/abs/2605.02700v1](https://arxiv.org/abs/2605.02700v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Neck-Learn: Attention-Based Multiple Instance Learning and Ensemble Framework for Ecological Momentary Assessment》所界定。 从摘要看，作者主要围绕 neck-learn、attention-based、multiple 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：On the held-out test set, our model exceeds the challenge baselines (AUC: 0.82 PVH, 0.77 NPVH), achieving AUCs of 0.879 for PVH (Rank 5) and 0.848 for NPVH (Rank 3), while also providing insights into clinically relevant information about both pathologies. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：neck-learn, attention-based, multiple。 |

---
### 2. Private Speech Classification without Collapse: Stabilized DP Training and Offline Distillation

👤 **作者**: Yadi Wen, Tianxin Li, Enji Liang, Rong Du, Yue Fu
🔗 **来源**: [https://arxiv.org/abs/2605.02718v1](https://arxiv.org/abs/2605.02718v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Private Speech Classification without Collapse: Stabilized DP Training and Offline Distillation》所界定。 从摘要看，作者主要围绕 private、speech、classification 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：This setting is important because speech systems can often exploit richer side information during development, whereas deployment and release require a lightweight unimodal model with auditable privacy guarantees. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：private, speech, classification。 |

---
### 3. Multi-Axis Speech Similarity via Factor-Partitioned Embeddings

👤 **作者**: Jim O'Regan, Jens Edlund
🔗 **来源**: [https://arxiv.org/abs/2605.02804v1](https://arxiv.org/abs/2605.02804v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Multi-Axis Speech Similarity via Factor-Partitioned Embeddings》所界定。 从摘要看，作者主要围绕 multi-axis、speech、similarity 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We evaluate on cross-corpus retrieval over corpora sharing the Harvard sentence prompts, demonstrating that signed axis weighting can suppress same-speaker bias and surface semantically matched utterances across recording conditions. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：multi-axis, speech, similarity。 |

---
### 4. Mixed-Precision Information Bottlenecks for On-Device Trait-State Disentanglement in Bipolar Agitation Detection

👤 **作者**: Joydeep Chandra
🔗 **来源**: [https://arxiv.org/abs/2605.03039v1](https://arxiv.org/abs/2605.03039v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Mixed-Precision Information Bottlenecks for On-Device Trait-State Disentanglement in Bipolar Agitation Detection》所界定。 从摘要看，作者主要围绕 mixed-precision、information、bottlenecks 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：On Bridge2AI-Voice (N=833, 4 sessions/participant, strict speaker-independent CV), MP-IB achieves rho = 0.117 (95\% CI: [0.089, 0.145], p=0.003 vs. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：mixed-precision, information, bottlenecks。 |

---
### 5. Phoneme-Level Deepfake Detection Across Emotional Conditions Using Self-Supervised Embeddings

👤 **作者**: Vamshi Nallaguntla, Shruti Kshirsagar, Anderson R. Avila
🔗 **来源**: [https://arxiv.org/abs/2605.03079v1](https://arxiv.org/abs/2605.03079v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Phoneme-Level Deepfake Detection Across Emotional Conditions Using Self-Supervised Embeddings》所界定。 从摘要看，作者主要围绕 phoneme-level、deepfake、detection 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our results show that phoneme behavior varies across categories, with complex vowels and fricatives exhibiting higher divergence while simpler phonemes remain more stable. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：phoneme-level, deepfake, detection。 |

---
### 6. DECKER: Domain-invariant Embedding for Cross-Keyboard Extraction and Recognition

👤 **作者**: Bikrant Bikram Pratap Maurya, Nitin Choudhury, Daksh Agarwal, Arun Balaji Buduru
🔗 **来源**: [https://arxiv.org/abs/2605.03384v1](https://arxiv.org/abs/2605.03384v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《DECKER: Domain-invariant Embedding for Cross-Keyboard Extraction and Recognition》所界定。 从摘要看，作者主要围绕 decker、domain-invariant、embedding 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Results on HEAR show DECKER improves keystroke identification over strong baselines, particularly in cross-keyboard and cross-user settings, with further gains from language-model rectification. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：decker, domain-invariant, embedding。 |
...
🔗 **来源**: [https://arxiv.org/abs/2605.03395v1](https://arxiv.org/abs/2605.03395v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《APEX: Large-scale Multi-task Aesthetic-Informed Popularity Prediction for AI-Generated Music》所界定。 从摘要看，作者主要围绕 apex、large-scale、multi-task 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Aesthetic quality and popularity capture complementary aspects of music that together prove valuable: in an out-of-distribution evaluation on the Music Arena dataset, comprising pairwise human preference battles across eleven generative music systems unseen during training, including aesthetic features consistently improves preference prediction, demonstrating strong generalisation of the learned representations across generative architectures. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：apex, large-scale, multi-task。 |
...
🔗 **来源**: [https://arxiv.org/abs/2605.03412v1](https://arxiv.org/abs/2605.03412v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Smart Passive Acoustic Monitoring: Embedding a Classifier on AudioMoth Microcontroller》所界定。 从摘要看，作者主要围绕 smart、passive、acoustic 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We also propose a process to optimize the model to fit the severe resource constraints of the AudioMoth, achieving a \~10kB RAM memory footprint and 20ms inference time. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：smart, passive, acoustic。 |

---
### 9. Deepfake Audio Detection Using Self-supervised Fusion Representations

👤 **作者**: Khalid Zaman, Qixuan Huang, Muhammad Uzair, Masashi Unoki
🔗 **来源**: [https://arxiv.org/abs/2605.03420v1](https://arxiv.org/abs/2605.03420v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Deepfake Audio Detection Using Self-supervised Fusion Representations》所界定。 从摘要看，作者主要围绕 deepfake、audio、detection 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：On the test set, the proposed system achieves an F1-score of 70.20% and an environmental EER of 16.54%, outperforming the baseline system. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：deepfake, audio, detection。 |

---
### 10. Cosmodoit: A Python Package for Adaptive, Efficient Pipelining of Feature Extraction from Performed Music

👤 **作者**: Corentin Guichaoua, Daniel Bedoya, Elaine Chew
🔗 **来源**: [https://arxiv.org/abs/2605.03541v1](https://arxiv.org/abs/2605.03541v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Cosmodoit: A Python Package for Adaptive, Efficient Pipelining of Feature Extraction from Performed Music》所界定。 从摘要看，作者主要围绕 cosmodoit、python、package 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Music performance analysis studies the acoustic variations introduced by performers and how these variations reflect musical interpretation and structure. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：cosmodoit, python, package。 |

---
### 11. AfriVox-v2: A Domain-Verticalized Benchmark for In-the-Wild African Speech Recognition

👤 **作者**: Busayo Awobade, Gabrial Zencha Ashungafac, Tobi Olatunji
🔗 **来源**: [https://arxiv.org/abs/2605.03590v1](https://arxiv.org/abs/2605.03590v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《AfriVox-v2: A Domain-Verticalized Benchmark for In-the-Wild African Speech Recognition》所界定。 从摘要看，作者主要围绕 afrivox-v、domain-verticalized、benchmark 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Recent large language models (LLMs) show strong speech recognition and translation capabilities for high-resource languages. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：afrivox-v, domain-verticalized, benchmark。 |

---
### 12. Ecologically-Constrained Task Arithmetic for Multi-Taxa Bioacoustic Classifiers Without Shared Data

👤 **作者**: Ragib Amin Nihal, Benjamin Yen, Runwu Shi, Takeshi Ashizawa, Kazuhiro Nakadai
🔗 **来源**: [https://arxiv.org/abs/2605.03914v1](https://arxiv.org/abs/2605.03914v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Ecologically-Constrained Task Arithmetic for Multi-Taxa Bioacoustic Classifiers Without Shared Data》所界定。 从摘要看，作者主要围绕 ecologically-constrained、task、arithmetic 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We show that independently fine-tuned BEATs encoders can be composed into a unified 661-species classifier via task vector arithmetic without sharing data. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：ecologically-constrained, task, arithmetic。 |

---
### 13. PHALAR: Phasors for Learned Musical Audio Representations

👤 **作者**: Davide Marincione, Michele Mancusi, Giorgio Strano, Luca Cerovaz, Donato Crisostomi, Roberto Ribuoli, Emanuele Rodolà
🔗 **来源**: [https://arxiv.org/abs/2605.03929v1](https://arxiv.org/abs/2605.03929v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《PHALAR: Phasors for Learned Musical Audio Representations》所界定。 从摘要看，作者主要围绕 phalar、phasors、learned 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We introduce PHALAR, a contrastive framework achieving a relative accuracy increase of up to $\approx 70\%$ over the state-of-the-art while requiring $<50\%$ of the parameters and a 7$\times$ training speedup. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：phalar, phasors, learned。 |

---
### 14. Towards Open World Sound Event Detection

👤 **作者**: P. H. Hai, L. T. Minh, L. H. Son
🔗 **来源**: [https://arxiv.org/abs/2605.03934v1](https://arxiv.org/abs/2605.03934v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Towards Open World Sound Event Detection》所界定。 从摘要看，作者主要围绕 sound event detection 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experimental results demonstrate that our method achieves marginally superior performance compared to existing leading techniques in closed-world settings and significantly improves over existing baselines in open-world scenarios. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
👤 **作者**: Jingyao Gong
🔗 **来源**: [https://arxiv.org/abs/2605.03937v1](https://arxiv.org/abs/2605.03937v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《MiniMind-O Technical Report: An Open Small-Scale Speech-Native Omni Model》所界定。 从摘要看，作者主要围绕 minimind-o、technical、report 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：It accepts text, speech, and image inputs, and returns both text and streaming speech. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：minimind-o, technical, report。 |
