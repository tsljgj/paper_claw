...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-03-12 11:26:05 CST → 2026-03-13 11:22:34 CST |
| 📄 论文总数 | **6** 篇 |
...
> 💡 今日共收录 6 篇新论文，主要分布在 Paralinguistics 1, Audio 5。
...
### 1. ReDimNet2: Scaling Speaker Verification via Time-Pooled Dimension Reshaping

👤 **作者**: Ivan Yakovlev, Anton Okhotnikov
🔗 **来源**: [https://arxiv.org/abs/2603.11841v1](https://arxiv.org/abs/2603.11841v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「副语言学」方向，核心任务由题目《ReDimNet2: Scaling Speaker Verification via Time-Pooled Dimension Reshaping》所界定。 从摘要看，作者主要围绕 speaker verification 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We present ReDimNet2, an improved neural network architecture for extracting utterance-level speaker representations that builds upon the ReDimNet dimension-reshaping framework. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：speaker verification。 |

---
## 🏷️ Audio

### 1. Acoustic-to-Articulatory Inversion of Clean Speech Using an MRI-Trained Model

👤 **作者**: Sofiane Azzouz, Pierre-André Vuissoz, Yves Laprie
🔗 **来源**: [https://arxiv.org/abs/2603.11845v1](https://arxiv.org/abs/2603.11845v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Acoustic-to-Articulatory Inversion of Clean Speech Using an MRI-Trained Model》所界定。 从摘要看，作者主要围绕 acoustic-to-articulatory、inversion、clean 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Results show that clean speech supports articulatory inversion effectively, achieving an RMSE of 1.56 mm, close to MRI-based performance. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：acoustic-to-articulatory, inversion, clean。 |

---
### 2. Reconstruction of the Vocal Tract from Speech via Phonetic Representations Using MRI Data

👤 **作者**: Sofiane Azzouz, Pierre-André Vuissoz, Yves Laprie
🔗 **来源**: [https://arxiv.org/abs/2603.11847v1](https://arxiv.org/abs/2603.11847v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Reconstruction of the Vocal Tract from Speech via Phonetic Representations Using MRI Data》所界定。 从摘要看，作者主要围绕 reconstruction、vocal、tract 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The results show that, among the models relying on phonetic representations, manual correction after alignment yields the best performance, approaching that of the baseline. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：reconstruction, vocal, tract。 |

---
### 3. Silent Speech Interfaces in the Era of Large Language Models: A Comprehensive Taxonomy and Systematic Review

👤 **作者**: Kele Xu, Yifan Wang, Ming Feng, Qisheng Xu, Wuyang Chen, Yutao Dou, Cheng Yang, Huaimin Wang
🔗 **来源**: [https://arxiv.org/abs/2603.11877v1](https://arxiv.org/abs/2603.11877v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Silent Speech Interfaces in the Era of Large Language Models: A Comprehensive Taxonomy and Systematic Review》所界定。 从摘要看，作者主要围绕 silent、speech、interfaces 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Silent Speech Interfaces (SSIs) emerge as a transformative paradigm that bypasses the acoustic stage by decoding linguistic intent directly from the neuro-muscular-articulatory continuum. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：silent, speech, interfaces。 |

---
### 4. Resurfacing Paralinguistic Awareness in Large Audio Language Models

👤 **作者**: Hao Yang, Minghan Wang, Tongtong Wu, Lizhen Qu, Ehsan Shareghi, Gholamreza Haffari
🔗 **来源**: [https://arxiv.org/abs/2603.11947v1](https://arxiv.org/abs/2603.11947v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Resurfacing Paralinguistic Awareness in Large Audio Language Models》所界定。 从摘要看，作者主要围绕 resurfacing、paralinguistic、awareness 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our experiments demonstrate that PE-FT protocol efficiently and effectively resurfaces the paralinguistic awareness, even surpassing the performance of the all-layer fine-tuning strategy. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：resurfacing, paralinguistic, awareness。 |

---
### 5. Dr. SHAP-AV: Decoding Relative Modality Contributions via Shapley Attribution in Audio-Visual Speech Recognition

👤 **作者**: Umberto Cappellazzo, Stavros Petridis, Maja Pantic
🔗 **来源**: [https://arxiv.org/abs/2603.12046v1](https://arxiv.org/abs/2603.12046v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Dr. SHAP-AV: Decoding Relative Modality Contributions via Shapley Attribution in Audio-Visual Speech Recognition》所界定。 从摘要看，作者主要围绕 shap-av、decoding、relative 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：However, how models balance these modalities remains unclear. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：shap-av, decoding, relative。 |
